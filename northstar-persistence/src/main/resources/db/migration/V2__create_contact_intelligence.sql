...
CREATE TABLE contact_intelligence (
    ...
    -- Contact Classification (VARCHAR with CHECK constraints for Spring Data JDBC compatibility)
    contact_type VARCHAR(50) NOT NULL,
    authority_level VARCHAR(50) NOT NULL DEFAULT 'INFORMATION_ONLY',
